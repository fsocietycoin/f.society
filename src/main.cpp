...
unsigned int nStakeMinAge = 25 * 60;	// minimum age for coin age: 25m
unsigned int nStakeMaxAge = 45 * 60 ;	// stake age of full weight: 45m
unsigned int nStakeTargetSpacing = 1 * 60;			// 1 min block spacing

int64 nChainStartTime = 1513292999;
...
const string strMessageMagic = "fsociety Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in fsociety
    bool fStrictPayToScriptHash = true; // Always active in fsociety
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "fsociety", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "12/16/2017  Welcome to f.Society.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x8a822bda9a9da8d8d2927b41eff204bc9b72c25b15dd82bc53ff65036ef60219"));
